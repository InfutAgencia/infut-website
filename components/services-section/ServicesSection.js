    ...
    <Container id="services">
      <Row col={3}>
        <ContentWrapper>
          <ContentBlock>
            <BlockImageContainer>
              <BlockImage src="/img/ship.webp" width="50%" height="50%" />
            </BlockImageContainer>
            <BlockText>
              <PinkColor>
        ...
        <ContentWrapper>
          <ContentBlock>
            <BlockImageContainer>
              <BlockImage src="/img/telescope.webp" width="50%" height="50%" />
            </BlockImageContainer>
            <BlockText>
        ...
        <ContentWrapper>
          <ContentBlock>
            <BlockImageContainer>
              <BlockImage src="/img/astronaut.webp" width="50" height="50%" />
            </BlockImageContainer>
            <BlockText>
